-- Conic 10
-- {-0.290, -0.166, -0.286, 0.569, -0.584, 3.6549, -0.8399}
-- {-0.290, -0.166, -0.286, 0.569, -0.584, 1.0948, 1.1609}
needs "../../HGates.m2"
R = RR_53
declareVariable \ {A, B, C, D, E, x, y, t}

-- 1. Given points
x1 = inputHGate (-1.0454)
y1 = inputHGate (-1.6236)
x2 = inputHGate (0.2213)
y2 = inputHGate (-3.3359)
x3 = (inputHGate (-1.6393500253896331)) * x - inputHGate (4.8730604077965705)
y3 = zeroHGate
x4 = zeroHGate
y4 = y * inputHGate (2.129548180727709) - inputHGate (-1.3628924830067972)
x5 = x
y5 = y
