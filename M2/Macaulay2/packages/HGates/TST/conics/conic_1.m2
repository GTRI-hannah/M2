-- Conic 1
-- {-0.750, 0.083, -0.819, -0.595, -0.280, 0.3274, -1.108}
-- {-0.750, 0.083, -0.819, -0.595, -0.280, 0.3503, 0.7835}
needs "../../HGates.m2"
R = RR_53
declareVariable \ {A, B, C, D, E, x, y, t}

-- 1. Given points
x1 = inputHGate (-0.3572)
y1 = inputHGate (-1.3728)
x2 = inputHGate (-0.1618)
y2 = inputHGate (0.9812)
x3 = (inputHGate 106.65502183406126) * x - inputHGate (-36.53705414847166)
y3 = zeroHGate
x4 = zeroHGate
y4 = y * inputHGate (1.182500660851176) - inputHGate (0.020610732223103057)
x5 = x
y5 = y
