-- Conic 14
-- {-0.197, -0.138, -0.203, 0.537, -0.513, 2.4097, 1.0813}
-- {-0.197, -0.138, -0.203, 0.537, -0.513, 2.0891, 1.2072}
needs "../../HGates.m2"
R = RR_53
declareVariable \ {A, B, C, D, E, x, y, t}

-- 1. Given points
x1 = inputHGate (-0.8971)
y1 = inputHGate (0.6817)
x2 = inputHGate (-1.1435)
y2 = inputHGate (0.3077)
x3 = (inputHGate (-16.437616968184663)) * x - inputHGate (38.33912560823458)
y3 = zeroHGate
x4 = zeroHGate
y4 = y * inputHGate (40.56949960285937) - inputHGate (-47.68539992057184)
x5 = x
y5 = y
