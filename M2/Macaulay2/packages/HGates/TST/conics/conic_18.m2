-- Conic 18
-- {-0.271, -0.132, -0.221, 0.426, -0.618, -0.9345, 0.5846}
-- {-0.271, -0.132, -0.221, 0.426, -0.618, 0.8215, -4.4702}
needs "../../HGates.m2"
R = RR_53
declareVariable \ {A, B, C, D, E, x, y, t}

-- 1. Given points
x1 = inputHGate (1.5427)
y1 = inputHGate (-4.6941)
x2 = inputHGate (1.8097)
y2 = inputHGate (-4.7235)
x3 = (inputHGate 2.3629271070615037) * x - inputHGate (0.9188553815489753)
y3 = zeroHGate
x4 = zeroHGate
y4 = y * inputHGate (-1.007557173379758) - inputHGate (-3.356982076442194)
x5 = x
y5 = y
