-- Conic 24
-- {-0.476, 0.315, -0.609, -0.974, -0.648, -0.4744, -2.2842}
-- {-0.476, 0.315, -0.609, -0.974, -0.648, -1.506, -2.6905}
needs "../../HGates.m2"
R = RR_53
...
-- 1. Given points
x1 = inputHGate (-0.416)
y1 = inputHGate (0.9672)
x2 = inputHGate (-2.5607)
y2 = inputHGate (0.2316)
x3 = (inputHGate (-3.4372818922062813)) * x - inputHGate (-4.42554652966266)
y3 = zeroHGate
x4 = zeroHGate
y4 = y * inputHGate (-6.831405365493472) - inputHGate (-17.524096135860187)
x5 = x
y5 = y
