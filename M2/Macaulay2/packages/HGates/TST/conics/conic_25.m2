-- Conic 25
-- {-0.677, -0.101, -0.473, 0.218, -0.930, 0.2141, -2.7826}
-- {-0.677, -0.101, -0.473, 0.218, -0.930, 0.6359, 0.6615}
needs "../../HGates.m2"
R = RR_53
declareVariable \ {A, B, C, D, E, x, y, t}

-- 1. Given points
x1 = inputHGate (0.2432)
y1 = inputHGate (0.7685)
x2 = inputHGate (-0.3826)
y2 = inputHGate (-2.5587)
x3 = (inputHGate 5.811522048364153) * x - inputHGate (-2.309046870554765)
y3 = zeroHGate
x4 = zeroHGate
y4 = y * inputHGate (1.0190180308353416) - inputHGate (0.09801957260242178)
x5 = x
y5 = y
