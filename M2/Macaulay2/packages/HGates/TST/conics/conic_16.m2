-- Conic 16
-- {-0.808, -0.015, -0.827, 0.294, -0.105, -0.4702, 0.8513}
-- {-0.808, -0.015, -0.827, 0.294, -0.105, 1.1298, 0.5331}
needs "../../HGates.m2"
R = RR_53
declareVariable \ {A, B, C, D, E, x, y, t}

-- 1. Given points
x1 = inputHGate (0.7774)
y1 = inputHGate (-1.0194)
x2 = inputHGate (-0.392)
y2 = inputHGate (-1.0206)
x3 = (inputHGate 1.4087500000000002) * x - inputHGate (-0.2826057499999999)
y3 = zeroHGate
x4 = zeroHGate
y4 = y * inputHGate (-6.922061596480204) - inputHGate (4.727851037083597)
x5 = x
y5 = y
