-- Conic 27
-- {0.131, 0.261, 0.097, 0.772, 0.677, -2.6915, -1.018}
-- {0.131, 0.261, 0.097, 0.772, 0.677, 5.143, -5.7742}
needs "../../HGates.m2"
R = RR_53
declareVariable \ {A, B, C, D, E, x, y, t}

-- 1. Given points
x1 = inputHGate (3.1838)
y1 = inputHGate (-4.435)
x2 = inputHGate (-0.9379)
y2 = inputHGate (-1.2644)
x3 = (inputHGate 0.259301806113983) * x - inputHGate (-3.258889188844215)
y3 = zeroHGate
x4 = zeroHGate
y4 = y * inputHGate (-0.5792439342332112) - inputHGate (-5.464070325049408)
x5 = x
y5 = y
