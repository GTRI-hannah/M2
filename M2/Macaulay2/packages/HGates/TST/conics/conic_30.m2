-- Conic 30
-- {-0.773, 0.358, -0.667, -0.731, -0.979, 0.2486, -1.9317}
-- {-0.773, 0.358, -0.667, -0.731, -0.979, 0.7801, -0.9864}
needs "../../HGates.m2"
R = RR_53
...
-- 1. Given points
x1 = inputHGate (-1.626)
y1 = inputHGate (-2.4293)
x2 = inputHGate (-0.1284)
y2 = inputHGate (-2.2549)
x3 = (inputHGate 4.634242709313264) * x - inputHGate (-2.8564727375352774)
y3 = zeroHGate
x4 = zeroHGate
y4 = y * inputHGate (3.0196762932402414) - inputHGate (3.6721086956521742)
x5 = x
y5 = y
