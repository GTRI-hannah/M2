-- Conic 2
-- {-0.630, -0.191, -0.598, 0.567, -0.672, 0.108, -2.0281}
-- {-0.630, -0.191, -0.598, 0.567, -0.672, 1.0544, -2.1567}
needs "../../HGates.m2"
R = RR_53
declareVariable \ {A, B, C, D, E, x, y, t}

-- 1. Given points
x1 = inputHGate (-0.5208)
y1 = inputHGate (-1.5385)
x2 = inputHGate (1.7669)
y2 = inputHGate (-1.7215)
x3 = (inputHGate 2.826711749788673) * x - inputHGate (-1.1928848689771767)
y3 = zeroHGate
x4 = zeroHGate
y4 = y * inputHGate (-21.93312597200621) - inputHGate (-46.455072783825784)
x5 = x
y5 = y
