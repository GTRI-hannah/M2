-- Conic 29
-- {-0.898, -0.106, -0.819, 0.325, -0.651, 0.974, -1.3441}
-- {-0.898, -0.106, -0.819, 0.325, -0.651, -0.1305, -1.5306}
needs "../../HGates.m2"
R = RR_53
declareVariable \ {A, B, C, D, E, x, y, t}

-- 1. Given points
x1 = inputHGate (0.2719)
y1 = inputHGate (-1.6074)
x2 = inputHGate (0.242)
y2 = inputHGate (-1.6069)
x3 = (inputHGate (-1.9383431416930739)) * x - inputHGate (0.998646220009054)
y3 = zeroHGate
x4 = zeroHGate
y4 = y * inputHGate (-12.595710455764083) - inputHGate (-18.502294423592502)
x5 = x
y5 = y
