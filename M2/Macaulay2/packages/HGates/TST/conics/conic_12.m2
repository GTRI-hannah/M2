-- Conic 12
-- {-0.536, -0.170, -0.688, 0.871, -0.389, 0.7071, 1.0781}
-- {-0.536, -0.170, -0.688, 0.871, -0.389, 0.7333, 1.077}
needs "../../HGates.m2"
R = RR_53
declareVariable \ {A, B, C, D, E, x, y, t}

-- 1. Given points
x1 = inputHGate (0.2635)
y1 = inputHGate (-1.6694)
x2 = inputHGate (-0.2701)
y2 = inputHGate (0.8074)
x3 = (inputHGate 121.36259541984732) * x - inputHGate (-86.59219122137404)
y3 = zeroHGate
x4 = zeroHGate
y4 = y * inputHGate (-2251.9090909088845) - inputHGate (2426.261690908869)
x5 = x
y5 = y
