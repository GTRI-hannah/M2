-- Conic 26
-- {-0.359, 0.000, -0.360, -0.046, -0.012, 0.1162, -1.676}
-- {-0.359, 0.000, -0.360, -0.046, -0.012, 0.9323, -1.3562}
needs "../../HGates.m2"
R = RR_53
declareVariable \ {A, B, C, D, E, x, y, t}

-- 1. Given points
x1 = inputHGate (-0.5262)
y1 = inputHGate (-1.6207)
x2 = inputHGate (1.4497)
y2 = inputHGate (-0.7221)
x3 = (inputHGate 4.092268104398971) * x - inputHGate (-2.2090215537311604)
y3 = zeroHGate
x4 = zeroHGate
y4 = y * inputHGate (10.42933083176986) - inputHGate (15.794958474046286)
x5 = x
y5 = y
