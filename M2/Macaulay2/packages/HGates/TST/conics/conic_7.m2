-- Conic 7
-- {-0.581, -0.098, -0.438, 0.247, -0.794, -0.8493, -2.0366}
-- {-0.581, -0.098, -0.438, 0.247, -0.794, 0.5778, -2.733}
needs "../../HGates.m2"
R = RR_53
declareVariable \ {A, B, C, D, E, x, y, t}

-- 1. Given points
x1 = inputHGate (0.1035)
y1 = inputHGate (-2.6969)
x2 = inputHGate (-0.7132)
y2 = inputHGate (-2.1994)
x3 = (inputHGate 1.862868754817462) * x - inputHGate (0.4658344334664706)
y3 = zeroHGate
x4 = zeroHGate
y4 = y * inputHGate (-5.057438253877081) - inputHGate (-12.966778747846062)
x5 = x
y5 = y
