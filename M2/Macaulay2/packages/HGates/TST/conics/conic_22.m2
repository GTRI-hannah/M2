-- Conic 22
-- {-0.189, -0.134, -0.159, 0.463, -0.577, 0.5708, -5.4771}
-- {-0.189, -0.134, -0.159, 0.463, -0.577, 3.5088, 0.2723}
needs "../../HGates.m2"
R = RR_53
declareVariable \ {A, B, C, D, E, x, y, t}

-- 1. Given points
x1 = inputHGate (1.3935)
y1 = inputHGate (1.3139)
x2 = inputHGate (-1.1061)
y2 = inputHGate (-3.1977)
x3 = (inputHGate 1.7735874744724303) * x - inputHGate (-2.393463730428863)
y3 = zeroHGate
x4 = zeroHGate
y4 = y * inputHGate (1.075138275298292) - inputHGate (0.9874398476362751)
x5 = x
y5 = y
