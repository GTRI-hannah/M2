-- Conic 9
-- {-0.907, 0.125, -0.999, -0.702, -0.357, -1.2904, -0.9399}
-- {-0.907, 0.125, -0.999, -0.702, -0.357, 0.2208, 0.7457}
needs "../../HGates.m2"
R = RR_53
declareVariable \ {A, B, C, D, E, x, y, t}

-- 1. Given points
x1 = inputHGate (-0.9484)
y1 = inputHGate (0.7147)
x2 = inputHGate (-1.2908)
y2 = inputHGate (0.4207)
x3 = (inputHGate 1.4808099523557436) * x - inputHGate (0.40493716251985146)
y3 = zeroHGate
x4 = zeroHGate
y4 = y * inputHGate (1.2059800664451827) - inputHGate (-0.061399335548172784)
x5 = x
y5 = y
